...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'wbiscuit'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'wbiscuit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'wbiscuit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'wbiscuit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Bakery - Water Biscuit</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/cracker.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Water Biscuit</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    Water Biscuits, or crackers in the USA, areflat biscuits, either round or square, and creamy-white in colour with brown spots. Compared to most other biscuits or crackers, they are comparatively soft and flaky.
...
<div class="container-fluid">
    <img src="img/crackersRR.jpg" id="ama-rec" alt="image recipe">
</div>
...
<div class="parag-container">
    ...
    <br>150g plain flour
    <br> 1 tsp flaky sea salt
    <br>1 tsp golden caster sugar
    <br>1 tbsp finely chopped rosemary
    <br>80ml water mixed with 2 tbsp olive oil
</div>
</div>
<br>
<div class="col" >
