...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'muffin'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'muffin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'muffin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'muffin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/muffin.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Muffin</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    Moufflet means soft bread in French. This is the origin of the word muffin, even thought it was made famous because of the north-american pastry tradition. Only few people know that until today mostly sweet muffins went through a lot of changes. 
<!--     COMMENT change text-->
...
<div class="container-fluid">
    <img src="img/muffinRR.jpg" id="ama-rec" alt="image recipe">
</div>

    <div class="card-body">
        <strong>12 Servings<br>
        Prep Time: 10 min<br>
        Total Time: 30min </strong>
        </div>
  </div>
</div>
<br><br>
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS - Blueberry Muffins:
    <br>1 cup milk
    <br>1 egg
