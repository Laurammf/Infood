...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'brownie'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'brownie'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'brownie'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'brownie'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/browniesRR.jfif" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Brownies</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
        Cakey on the outside and fudgy in the middle, the brownies were born in the USA and have conquired millions of hearts all atound the world. 
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/brownies.jpg" id="ama-rec" alt="image recipe"> 
<!--    COMMENT change immage-->
</div>
        

 <div class="card-body">
        <strong>20 Servings<br>
        Prep Time: 15 min<br>
        Total Time: 35 min </strong>
        </div>
  </div>
</div>
<br><br>
...
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        ...
        <p id="recipe-paragraph"> 
            ...
            <br>Combine the melted butter, sugar, cocoa powder, vanilla, eggs, flour, baking powder, and salt. Spread the batter into the prepared pan. Decorate with walnut halves, if desired.
            <br>Bake in preheated oven for 20 to 30 minutes or until a toothpick inserted in the center comes out with crumbs, not wet. Cool on wire rack.
        </p>  
        </div>
    </div>
    </div>
