...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'ciabatta'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'ciabatta'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'ciabatta'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'ciabatta'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/ciabatta.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Ciabatta</h1> 
<!--            COMMENT change name -->
...
<div class="container-fluid">
    <img src="img/ciabatta.jpg" id="ama-rec" alt="image recipe">
</div>

    <div class="card-body">
        <strong>2 Loaves<br>
        Prep Time:30 min<br>
        Total Time: 2 hours </strong>
        </div>
  </div>
</div>
<br><br>
...
<div class="parag-container">
    ...
    <br>1 ½ teaspoons bread machine yeast
</div>
</div>
<br>
<div class="col" >
