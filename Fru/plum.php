...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'plum'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'plum'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'plum'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'plum'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/Plum.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Plum</h1> 
<!--            COMMENT change name -->
