...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'amaranth'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'amaranth'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'amaranth'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'amaranth'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Vegetables - Amaranth</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/amaranth.png" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Amaranth</h1> 
<!--            COMMENT change name -->
...
<div class="container-fluid">
    ...
    <img src="img/amaranth-recipe.jpg" id="ama-rec" alt="image recipe"> 
<!--    COMMENT change immage-->
</div>
        

    <div class="card-body">
        <strong>10 Servings<br>
        Prep Time: 20 min<br>
        Total Time: 50 min</strong>
        </div>
  </div>
</div>
<br><br>
...
<br>2 heaping tbsp chopped garlic I know that sounds like a lot, but trust me, you'll be singing for joy when the dish is ready
<br>1 large tomato finely diced
<br>1 tsp red pepper flakes or chilli powder use more or less per taste<br>
1/2 tsp turmeric<br>
...
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        <div class="card-body">
        <p id="recipe-paragraph"> Chop the amaranth leaves finely and place in a large pot or in a pressure cooker along with the mung dal and turmeric. Add enough water to cover by about an inch. Bring to a boil, cover, and cook until tender, adding more water if needed. Or if using pressure cooker, pressure-cook for the recommended amount of time for mung dal.
           <br><br> Heat the oil. When it shimmers, add the cumin seeds, stir for a few seconds, then add the garlic.
           <br> Saute for 30 seconds, then add the tomatoes. Let the tomatoes cook down until they are pulpy.
           <br>Add the cumin and coriander powders, aamchur, and red pepper flakes or chilli powder.
           <br> Stir everything well and let it all cook for a couple of minutes.
           <br><br> Add the dal along with the amaranth leaves. Bring to a boil and lower heat to a simmer. Add water if the dal is too thick. It really depends on your taste-- I like my dal slightly runny.
           <br><br>Let the dal simmer for about 5 minutes, then turn off heat and serve hot with rice or rotis.
        </p>  
        </div>
    </div>
    </div>
