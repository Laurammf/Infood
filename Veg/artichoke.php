...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'artichoke'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'artichoke'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'artichoke'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'artichoke'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Vegetables - Artichoke</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/artichoke.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Artichoke</h1> 
<!--            COMMENT change name -->
...
Artichoke is one of the favorite winter season edible flower buds. 
    <br>
    Botanically, it belongs to the thistle family (Asteraceae), in the genus: Cynara. Scientific name: Cynara cardunculus var. scolymus.
    <br><br>
...
<div class="container-fluid">
    <img src="img/artichoke-and-feta-tarts.jpg" alt="image recipe">
</div>

    <div class="card-body">
        <strong>6 Servings<br>
        Prep Time: 15 min<br>
        Total Time: 45 min</strong>
        </div>
  </div>
</div>
<br><br>
...
<br>
        ...
        4 ounces feta, divided<br>
        Kosher salt, freshly ground pepper<br>
        1 14-ounce (1 sheet) or 17.3-ounce (2 sheets) package frozen puff pastry, thawed<br>
        All-purpose flour (for work surface)<br>
        2 4-ounce jars marinated artichoke hearts, drained, halved<br>
...
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        <div class="card-body">
        <p id="recipe-paragraph"> Preheat oven to 425°. Blend cream and 2 ounces feta in a food processor until smooth; season with salt and pepper.<br>
           ...
           <br> Spread feta mixture over pastry, dividing evenly and staying within border. Arrange artichoke hearts over feta mixture and crumble remaining 2 ounces feta over; drizzle with oil. Brush pastry border with egg.
            
            <br><br>Bake tart until pastry is puffed and beginning to brown, 10-15 minutes. Reduce oven temperature to 375° and continue to bake until pastry is deep golden brown and cooked through, 20-25 minutes longer. Serve warm or at room temperature.
        </p>  
        </div>
    </div>
    </div>
