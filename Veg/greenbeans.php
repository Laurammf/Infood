...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'greenb'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'greenb'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'greenb'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'greenb'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Vegetables - Green Beans</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/greenbeans.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Green Beans</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
Green beans, also known as French beans or snap beans, are tender, elongated, firm yet flexible edible pods of the bean plant. The beans are one of the delights of vegetarian lovers for their wholesome nutritional properties. They are the unripe or immature pods belonging to the common Fabaceae family, of the genus, Vicia. Scientific name: Phaseolus vulgaris. <br>
...
<div class="container-fluid">
    <img src="img/green-rec.jpg" alt="image recipe" >
</div>
...
Kosher salt<br>
¼ tsp. sugar<br>
12 oz. trimmed string beans, sugar snap peas, and/or snow peas<br>
½ cup fresh or frozen baby peas, thawed<br>
2 scallions, thinly sliced<br></p>
</div>
</div>
<br>
<div class="col" >
    ...
    <div class="card bg-light text-dark" >
        ...
        <p id="recipe-paragraph"> Mix garlic, soy sauce, miso, curry powder, ginger, and 1 Tbsp. oil in a small bowl; set aside.
           ...
           <br> Spread feta mixture over pastry, dividing evenly and staying within border. Arrange artichoke hearts over feta mixture and crumble remaining 2 ounces feta over; drizzle with oil. Brush pastry border with egg.
            ...
            <br>Transfer chicken and vegetables to a platter. Top with scallions.
        </p>  
        </div>
    </div>
    </div>
