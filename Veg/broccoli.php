...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'broccoli'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'broccoli'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'broccoli'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'broccoli'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/broccoli.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Broccoli</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
Broccoli is a cabbage family vegetable grown for its nutritious flower heads. Its green or purple florets knew for several noteworthy, unique phytonutrients that have been found to have disease preventing and health promoting properties.<br>
    Botanically, the vegetable is a member of large cruciferous (Brassica) family of vegetables, which also include cauliflower, brussel sprouts, cabbage, and arugula. <br><br>
    Once established, broccoli plant bears about 4-10 inches wide, dark green to purple color flower-heads depending on the cultivar type.
...
<div class="container-fluid">
    <img src="img/sausage-and-broccoli-rabe-frittata.jpg" alt="image recipe" >
</div>

    <div class="card-body">
        <strong>8 Servings<br><br>
            Sausage and Broccoli Rabe Frittata</strong>
        </div>
  </div>
</div>
<br><br>
...
12 large eggs<br>
½ cup whole milk<br>
¾ cup grated cheddar, divided<br>
Kosher salt and coarsely ground black pepper<br>
2 tablespoons vegetable oil<br>
½ medium onion, chopped<br>
½ pounds fresh Spanish chorizo or hot Italian sausage links, casings removed<br>
...
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        <div class="card-body">
        <p id="recipe-paragraph"> Preheat broiler. Whisk eggs and milk in a medium bowl. Mix in ½ cup cheddar; season with salt and pepper and set aside.
           <br> If using 14-ounce package of puff pastry, cut in half and roll out each half on a lightly floured surface into a 16x10-inch rectangle. (If using 17.3-ounce package, use 1 sheet of pastry for each tart.) Transfer each piece of pastry to a parchment-lined baking sheet. Using a paring knife, lightly score pastry (do not cut all the way through), leaving a 1-inch border.<br>
            
           <br> Heat oil in a large skillet, preferably cast-iron, over medium heat. Add onion and chorizo and cook, stirring occasionally, until onion is softened and chorizo is brown, 6–8 minutes. Add broccoli rabe; season with salt and pepper and cook, stirring occasionally, until tender, 8–10 minutes longer.
            <br>Reduce heat to low and pour reserved egg mixture over vegetables. Cook, shaking pan occasionally, until edges are just set, 10–12 minutes. Top frittata with remaining ¼ cup cheddar; broil until top is golden brown and center is set, about 4 minutes longer.


            <br><br>Cut frittata into wedges and serve warm or room temperature.
        </p>  
        </div>
    </div>
    </div>
