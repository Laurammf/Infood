...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'carrot'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'carrot'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'carrot'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'carrot'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/carrot.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Carrot</h1> 
<!--            COMMENT change name -->
...
<br>
Botanically they are the taproots belong to the Apiaceae or umbelliferous family in the genus; Daucus. 
...
<div class="container-fluid">
    <img src="img/carrot-recipe.jpg" alt="image recipe">
</div>
...
<br>
½ cup skin-on almonds
<br>2 lb. carrots, trimmed, peeled<br>
2 Tbsp. plus ½ cup extra-virgin olive oil; plus more<br>
2½ tsp. kosher salt, divided, plus more<br>
2 garlic cloves<br>
½ cup canned chickpeas<br>
3 Tbsp. (or more) fresh lemon juice<br>
1 tsp. freshly ground black pepper<br>

¾ tsp. hot smoked Spanish paprika<br>
½ cup coarsely chopped parsley, plus leaves for serving<br></p>
</div>
</div>
<br>
<div class="col" >
...
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        <div class="card-body">
        <p id="recipe-paragraph"> Preheat oven to 350°. Toast almonds on a rimmed baking sheet, tossing halfway through, until slightly darkened and fragrant, 8–10 minutes. Let cool; set aside.
            <br><br>Preheat oven to 350°. Toast almonds on a rimmed baking sheet, tossing halfway through, until slightly darkened and fragrant, 8–10 minutes. Let cool; set aside.
        <br><br>Transfer carrots to a food processor; add garlic, chickpeas, lemon juice, pepper, paprika, chopped parsley, ½ cup oil, 1½ tsp. salt, and reserved almonds. Process, adding more oil as needed, until mixture is almost completely smooth. Taste dip and add more lemon juice and/or salt if needed.
    <br><br>Transfer dip to a small bowl, drizzle with more oil, and top with parsley leaves.
</p>  
        </div>
    </div>
    </div>
