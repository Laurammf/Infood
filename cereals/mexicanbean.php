...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'mexicanbean'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'mexicanbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'mexicanbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'mexicanbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Cereals - Mexican Beans</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/mexicanbean.jpg"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Mexican Beans</h1> 
<!--            COMMENT change name -->
...
<div class="col" >
    <div class=" row justify-content-center">
    <h2>Recipe: Easy Mexican Bean Soup</h2>
    </div>
    <br>
...
<div class="container-fluid">
    ...
    <img src="img/mexicanbeanRR.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
    ...
    <br>2 x 400g tins Asda Mexican Style Bean Mix, rinsed and drained
    <br>400g tin Asda Chopped Tomatoes in Tomato Juice
    <br>1 reduced-salt vegetable stock cube, make up to 600ml with boiling water
    <br>2tsp ground cumin
    <br>½tsp mild chilli powder
    <br>198g tin Asda Sweetcorn in Water, drained
    <br>4tbsp low-fat natural yogurt
    <br>1 lime, cut into wedges
    <br>Coriander, to serve
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
    Put the beans, chopped tomatoes, stock and spices into a large pan and bring to the boil on a medium-high heat. Simmer for 15 mins, stirring occasionally, until the tomatoes start to break down.
    <br>Season with black pepper, add the sweetcorn and simmer for another 2-3 mins until heated through. Ladle into bowls and serve with a dollop of yogurt, a squeeze of lime and some coriander, if you like.
        </p>  
        </div>
    </div>
    </div>
