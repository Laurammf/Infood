...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'lentil'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'lentil'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'lentil'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'lentil'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/lentil.png"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Lentil</h1> 
<!--            COMMENT change name -->
...
<br>In cuisines of the Indian subcontinent, where lentils are a staple, split lentils (often with their hulls removed) known as daal are often cooked into a thick curry/gravy that is usually eaten with rice or rotis.
</p>
</div>
<br><br>
...
<div class="col" >
    <div class=" row justify-content-center">
    <h2>Recipe: Beetroot and Lentil Tabbouleh</h2>
    </div>
    <br>
...
<div class="container-fluid">
    ...
    <img src="img/lentilRR.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
    ...
    <br>1 small pack flat-leaf parsley, plus extra leaves to serve (optional)
    <br> small pack mint
   <br>1 small pack chives
   <br>200g radishes
   <br>2 beetroot, peeled and quartered
   <br>1 red apple, cored, quartered and sliced
   <br>1 tsp ground cumin
   <br>4 tbsp olive oil
   <br>250g pack cooked quinoa
   <br>400g can chickpeas, drained and rinsed
   <br>400g can green lentils, drained
   <br>2 lemons, juiced
</div>
</div>
<br>
