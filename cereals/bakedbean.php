...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'bakedbean'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'bakedbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'bakedbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'bakedbean'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Cereals - Baked Beans</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/bakedbean.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Baked Beans</h1> 
<!--            COMMENT change name -->
...
<div class="col" >
    <div class=" row justify-content-center">
    <h2>Recipe: Homemade Baked Beans</h2>
    </div>
    <br>
...
<div class="container-fluid">
    ...
    <img src="img/bakedbeanRR.jpg" id="ama-rec" alt="image recipe"> 
<!--    COMMENT change immage-->
</div>
        

    <div class="card-body">
        <strong>3 Servings<br>
...
<div class="parag-container">
    ...
    <br>1 - 2 tsp Spanish Smoked Paprika * See Notes
    <br>300g (1 1/3 cups) Passata
    <br>1 tbsp Tomato Puree (Tomato Paste)
    <br>60ml (1/4 cup) Chicken / Vegetable Stock *See Notes
    <br>300g (10.5oz) Can Haricot (Navy) beans (drained weight 195g/ 6.8oz)
</div>
<br>
<div class="col" >
    <div class=" row justify-content-center">
<h3>Recipe Preparation</h3>
    ...
    <div class="card bg-light text-dark" >
        ...
        <br>Heat oil in a sauce pan over a medium heat.
        <br>Add the garlic and allow to sizzle but be careful not to burn.
        <br>Reduce heat to low, add the smoked paprika and stir.
        <br>Add the passata, puree and stock and then simmer for around 20 mins (until the sharp taste of tomato has gone and the <br>sauce has thickened.)
        <br>Add the beans and simmer for a further 10 mins.
        <br>Season to taste.
        </p>  
        </div>
    </div>
