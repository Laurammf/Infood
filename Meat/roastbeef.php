...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'roastbeef'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'roastbeef'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'roastbeef'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'roastbeef'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/beef-loin.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Roast beef</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
	...
	<br> Beef is a source of high-quality protein and nutrients.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/primeribroast.jpeg" id="ama-rec" alt="image recipe"> 
<!--    COMMENT change immage-->
    ...
    <div class="card-body">
        ...
        Prep Time: 15 min<br>
        Total Time: 1 hour 20 min</strong>
        </div>
  </div>
</div>
<br><br>
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
    	<br>2 3-to-4-rib roast of beef, approximately 8 to 10 pounds
    	<br>2  tablespoons unsalted butter
    	<br> ¼ cup all-purpose flour
    	<br>2  tablespoons kosher salt
    	<br>2  tablespoons freshly ground black pepper
</div>
</div>
<br>
<div class="col" >
