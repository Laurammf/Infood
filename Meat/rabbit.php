...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'rabbit'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'rabbit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'rabbit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'rabbit'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/rabbit-meat.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Rabbit</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    	As a meat, Rabbit is fine-textured and almost all white, with a flavor and appearance similar to chicken meat. Hare however, is very dark in color and provides a stronger flavor that tastes dark meat from wild game. 
	<br>For preparation, the most popular method to cook Rabbit or Hare is by frying or oven roasting. Cooked in a similar manner to chicken, Rabbit can be served whole as the main meal or prepared for appetizers, stews and salads.	
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/rabbit-au-vin.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
    	...
    	<br>2 celery sticks, thinly sliced
    	<br>300g carrots, thickly sliced
    	<br>200g pack unsmoked bacon lardons (or use streaky bacon)
    	<br>3 wild rabbits, jointed into shoulders, legs and saddle pieces (mine were 600g each, gutted weight, no heads)
    	<br>2 tbsp plain flour, seasoned well
    	<br>25g butter, plus a knob
    	<br>1 tbsp olive oil
    	<br>600ml full-bodied red wine
    	<br>400ml chicken stock
    	<br>2 bay leaves
    	<br>few thyme sprigs, plus extra to garnish
    	<br>300g button mushrooms
</div>
</div>
<br>
<div class="col" >
