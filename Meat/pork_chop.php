...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'pork_chop'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'pork_chop'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'pork_chop'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'pork_chop'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/pork-chops.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Pork chop</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    	A pork chop, like other meat chops, is a loin cut taken perpendicular to the spine of the pig and usually containing a rib or part of a vertebra. 
	<br>Pork chops are not processed and are leaner than other cuts of pork. Chops are commonly served as an individual portion.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/pork-chops-del.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
   	<br>2 4 pork loin chops
   	<br>kosher salt
   	<br>Freshly ground black pepper
   	<br>1 tbsp. freshly minced rosemary
...
<!--            comment change recipe-->
	...
	<br>
     	<br>Place skillet in oven and cook until cooked through (145° for medium), 10-12 minutes. Serve with more garlic butter.
