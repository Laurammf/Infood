...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'beef_tenderloin'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'beef_tenferloin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'beef_tenderloin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'beef_tenderloin'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Meat - Beef tenderloin</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/beef_tenderloin.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Beef tenderloin</h1> 
<!--            COMMENT change name -->
        </div>
    </div>
</div> <br>
...
<p class="lead">
    	Beef tenderloin is cut from the loin of a cow. 
	<br><br>
	...
	<br><br>Several steaks are actually cut from this region, including the filet mignon, chateaubriand, and tournedos.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/beef.jpg" id="ama-rec" alt="image recipe">> 
<!--    COMMENT change immage-->
</div>
        

    <div class="card-body">
        <strong>6 Servings<br>
        Prep Time: 25 minutes <br>
        Total Time: 1 hours </strong>
        </div>
  </div>
</div>
<br><br>
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
    	<br>1 2-1/2- to 3-lb. beef tenderloin roast (preferably the head piece), trimmed of silverskin, at room temperature
	<br>1 Tbs. extra-virgin olive oil 
	<br>Kosher salt and freshly ground black pepper
	<br>4 Tbs. cold unsalted butter
	<br>3 large shallots, halved and thinly sliced lengthwise (about 1 cup)
	<br>3/4 cup dry red wine, preferably a fruity California Cabernet Sauvignon
	<br>1 sprig fresh rosemary, plus 1/2 tsp. chopped
	<br>3/4 cup homemade or low-salt beef broth
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
	...
	<br><br>Roast the beef until an instant-read thermometer registers 120°F to 125°F for rare, about 25 min.; 125°F to 130°F for medium rare, about 30 min. (The temperature of the beef will rise 5°F as it rests.) Wrap the beef in the foil that lines the pan and let rest on a carving board for 10 to 15 min.
	<br><br>While the beef roasts, make the sauce. Melt 2 Tbs. of the butter in a 12-inch skillet over medium heat. Add the shallots and cook, stirring often, until they soften and turn golden brown, 8 to 10 min. Add the wine and the rosemary sprig and bring to a boil over medium-high heat. Boil until the volume of wine and shallots reduces to 1/2 cup, about 3 min. Add the broth and continue to boil until the sauce is reduced to 1 cup, about 5 min. Reduce the heat to low. Remove the rosemary sprig and stir in the chopped rosemary. Cut the remaining 2 Tbs. cold butter into small cubes and add a few of them at a time to the sauce, stirring to melt each addition.
	<br><br>Unwrap the tenderloin and stir any accumulated juices into the sauce. Season the sauce to taste with salt and pepper. Slice the meat and serve with the sauce.
	<br><br>TIP: It’s important to let the beef rest before slicing it; this allows the juices to redistribute from the outside of the roast throughout the whole roast, making this lean cut very juicy.
        </p>  
        </div>
    </div>
    </div>
