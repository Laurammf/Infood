...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'chicken'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'chicken'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'chicken'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'chicken'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/chicken.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Chicken</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
	...
	<br>Chicken can be prepared in a vast range of ways, including baking, grilling, barbecuing, frying, and boiling, among many others, depending on its purpose.
	<br>Chicken generally includes low fat in the meat itself (castrated roosters excluded). The fat is highly concentrated on the skin. (Source: Wikipedia).
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/grilled-chicken-with-coconut.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
	...
	<br>1 tsp. sugar
	<br>1/2 tsp. fish sauce
	<br>1 lb. red cabbage, thinly sliced
	<br>2 scallions, cut into matchsticks
	<br>1/4 c. cilantro
</div>
</div>
<br>
...
<!--            comment change recipe-->
	...
	<br><br>Season chicken with salt and pepper. Grill, turning once, until just cooked through, about 3 minutes.

	<br><br>Meanwhile, zest lime into small bowl and reserve. Squeeze 1 tablespoon juice from lime into large bowl. Add coconut milk, sugar, and fish sauce. Whisk until sugar dissolves, then toss in cabbage and scallions until evenly coated.

	<br><br>As soon as chicken comes off grill, sprinkle with lime zest. Divide chicken and slaw among serving plates. Sprinkle cilantro over slaw and serve.
        </p>  
        </div>
    </div>
    </div>
