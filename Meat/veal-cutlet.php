...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'veal-cutlet'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'veal-cutlet'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'veal-cutlet'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'veal-cutlet'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/veal-chop.jpg">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Veal</h1> 
<!--            COMMENT change name -->
...
<div class="container-fluid">
    ...
    <img src="img/veal-cutlets.jpg" id="ama-rec"> 
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
    	<br>6 veal cutlets (about 200g each), bones still attached
    	<br>4 eggs
    	<br>10 basil leaves, finely chopped
    	<br>2 tbsp finely grated parmesan
    	<br>200g dried breadcrumbs
    	<br>olive oil, for shallow-frying
    	<br>lemon wedges, fried courgettes and spring salad, to serve (optional)
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
          Use a tenderiser or rolling pin to flatten the chops, leaving the bone attached, then trim away the fat.       <br>
	...
	<br>
     	<br>Heat enough oil to cover the base of a large frying pan. Working in batches, fry the chops over a gentle heat for 3-4 mins each side, until the breadcrumbs turn a deep gold (you may need to add more oil to the pan as you go). Serve with a lemon wedge, some fried courgettes and a spring salad, if you like.
        </p>  
        </div>
    </div>
    </div>
