...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'herring'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'herring'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'herring'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'herring'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/herring.jpg"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Herring</h1> 
<!--            COMMENT change name -->
...
<div class="container-fluid">
    ...
    <img src="img/recipe-herring.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
    ...
    <br>4 x 75g/3oz herring
    <br>fillets or 4 x 225g/8oz herrings, gutted
    <br>4 tbsp extra-virgin olive oil
    <br>2 tbsp wholegrain mustard
    <br>large bunch basil, roughly torn
    <br>1 tsp clear honey
    <br>1 lemon, grated zest and juice
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
       ...
       <br>
       <br>Meanwhile, make the dressing: whisk the mustard, basil, honey, lemon zest and juice and remaining oil together in a small bowl, and season. Once the fish is cooked, spoon the dressing over and serve.
        </p>  
        </div>
    </div>
    </div>
