...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'sole'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'sole'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'sole'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'sole'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/soles.jpg" alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Sole</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    	Sole is  saltwater fish found in the Atlantic off the U.S. and European coasts.		<br>The best-known sole for eating, Dover sole, is in the Atlantic near Europe. 
	<br>It has lean, white flesh with a delicate flavor and firm, flaky texture. 
	<br>Sole is suitable for frying, broiling, baking, or poaching.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/sole-meuniere.jpg" id="ama-rec" alt="image recipe"> 
...
<div class="parag-container">
	...
	<br>4 fillets sole or plaice, skin-on (about 140g/5oz each)
	<br>6 tbsp plain flour
	<br>3 tbsp light olive oil or sunflower oil
	<br>85g butter, ideally unsalted
	<br>1 lemon, juice only
	<br>2 tbsp small caper (optional)
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
          Check the fish for small bones and pull any out with tweezers. In a large shallow bowl, season the flour with a little salt and black pepper. Toss the fish in the flour, coating well, and shake off any excess.       <br>
       <br>Heat the oil in a large frying pan. Add the fish and cook, skin-side down, for 2 mins. Use a fish slice or large spatula to turn, then cook the other side for 1-2 mins until golden.	<br>
     	<br>Remove the fish to a warmed plate, then season. Wipe out the pan with kitchen paper. Return the pan to the heat, then add the butter. Heat until it melts and begins to turn a light brown, then mix in the lemon juice and capers, if using. Swirl in the pan for a few secs, return fish to the pan and spoon over any juices. Serve immediately.	
        </p>  
        </div>
    </div>
    </div>
