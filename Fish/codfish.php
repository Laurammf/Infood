...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'codfish'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'codfish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'codfish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'codfish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/pesce_crudo.jpg"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Codfish</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    	Cod is a fish with flaky, white flesh and a mild flavor.
	<br>Cod is a popular, widely harvested fish because of its flaky, white flesh and mild taste.
	<br>Several species of fish within the genus Gadus are considered cod, including the Atlantic, Pacific, and Greenland cod varieties.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/baked-cod-fish.jpg" id="ama-rec" alt="image recipe">
...
<div class="parag-container">
    ...
    <p class="lead-recipe">INGREDIENTS:
    	<br>4 portions cod fish
	<br>1/2 teaspoon salt
	<br>1/4 teaspoon black pepper
	<br>1/4 cup softened butter
	...
	<br>1 lemon juiced
	<br>Additional lemon slices or wedges for serving
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
	...
	<br><br>Lay cod fish filets out in the prepared baking dish. Season fish with salt and pepper.
	<br><br>In a small bowl, stir together the butter, parmesan, flour, garlic, basil, onion powder, dijon mustard, and lemon juice.
	<br><br>Top each fillet with a large spoonful of the butter mixture.
	<br><br>Bake in the preheated oven for about 10 minutes. Actual cooking time will depend on the thickness of your fish. The fish is done when it flakes easily with a fork.
        </p>  
        </div>
    </div>
    </div>
