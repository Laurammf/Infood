...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'salmon'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'salmon'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'salmon'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'salmon'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/salmon.jpg"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Salmon</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
	...
	<br>Salmon is one of the best sources of the long-chain omega-3 fatty acids EPA and DHA.
	<br>This popular fatty fish is loaded with nutrients and may reduce risk factors for several diseases. 
	<br>It's also tasty, versatile and widely available.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/baked_salmon.jpg" id="ama-rec"  alt="image recipe"> 
...
<div class="parag-container">
	...
	<br>1 lb. salmon fillet
	<br>¼ cup Italian seasoned breadcrumbs
	<br>¼ cup grated Parmesan cheese
	<br>2 teaspoons minced fresh basil or ¾ t. dried basil
</div>
</div>
<br>
<div class="col" >
...
<!--            comment change recipe-->
       ...
       <br>
       <br>Spray a baking sheet with cooking spray (line with foil for easy cleanup, if desired).
	<br>
     	<br>Place salmon (skin side down) on the prepared baking sheet.
	<br>
     	<br>In a small bowl, stir together melted butter and lemon juice. Brush HALF of the butter mixture on the salmon.
	<br>
     	<br>Add breadcrumbs, Parmesan cheese, and basil to the remaining melted butter mixture. Stir to completely combine.
	<br>
     	<br>Use your fingers to gently press the buttered breadcrumbs onto the fish.
	<br>
     	<br>Bake for 12-18 minutes, or until the salmon flakes easily with a fork and topping is golden brown (total cooking time will vary depending on the thickness of your fish).
