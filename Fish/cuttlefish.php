...
<?php 
    ...
    $access1 = "SELECT * FROM nutfacts WHERE name = 'cuttlefish'";
...
<?php 
    // step 3 open access to DB
    $access2 = "SELECT vitc, vita, vitk FROM nutfacts WHERE name = 'cuttlefish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access3 = "SELECT sodium, potassium FROM nutfacts WHERE name = 'cuttlefish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<?php 
    // step 3 open access to DB
    $access4 = "SELECT iron, magnesium, phosporus, zinc FROM nutfacts WHERE name = 'cuttlefish'";
// COMMENT 3 CHANGE HERE name = 'name of your food from database';
...
<title>Mollusk - Cuttlefish</title>
...
<div class=" row justify-content-center">
    <div class="card" > <br><br>
        <img class="card-img-top" src="img/cuttlefish.jpeg"  alt="image food">
        <!--            COMMENT change foto -->
        <div class="card-body">
            <h1>Cuttlefish</h1> 
<!--            COMMENT change name -->
...
<p class="lead">
    	Cuttlefish are  mollusks belonging to the family Sepiidae, which in turn includes the Metasepia Genres, Sepia and Sepiella, and the cuttlefish found in the Mediterranean and the Atlantic Ocean typically found at our dinner tables, the species Sepia officinalis. 
	<br><br>Cuttlefish (Sepia officinalis) is widespread in local cuisine and its meat is tasty and valuable from a nutritional point of view.
<!--     COMMENT change text-->
...
<div class="container-fluid">
    ...
    <img src="img/chargrilled-garlic-and-chilli-cuttlefish.jpg" id="ama-rec" alt="image recipe">> 
...
<div class="parag-container">
	...
	<br>700g cuttlefish, cleaned, sliced into 3cm pieces
	<br>1/3 cup (80ml) extra virgin olive oil
	<br>Finfinely grated zest and juice of 1 lemon, plus extra wedges to serve
	<br>1 long red chilli, seeds removed, finely chopped
	<br>2 garlic cloves, finely chopped
	<br>2 tbs flat-leaf parsley, finely chopped
	<br>2 cups watercress sprigs
...
<!--            comment change recipe-->
       ...
       <br><br>When ready to cook, preheat barbecue or chargrill pan to high. Season cuttlefish with salt, then barbecue, turning, for 2 minutes or until lightly charred and just cooked through.
	<br><br>Toss cuttlefish with lemon juice and parsley in a bowl, then transfer to a platter and top with watercress. Serve with lemon wedges to squeeze over.
